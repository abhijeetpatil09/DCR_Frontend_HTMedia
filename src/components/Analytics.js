                     ...
                     <div class="bg-gray-200 p-4">
                        <div class="grid grid-cols-4 gap-4 mt-4">
                           <div class="mb-4 bg-white p-4 rounded-lg shadow">
                              <label for="ad_name" class="block text-cement font-bold mb-2">Ad Name:</label>
                              <input type="text" id="ad_name" name="ad_name" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 bg-cement text-white" ></input>
                           </div>
                           <div class="mb-4 bg-white p-4 rounded-lg shadow">
                              <label for="ad_set_name" class="block text-cement font-bold mb-2">Ad Set Name:</label>
                              <input type="text" id="ad_set_name" name="ad_set_name" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 bg-cement text-white" ></input>
                           </div>
                           <div class="mb-4 bg-white p-4 rounded-lg shadow">
                              <label for="campaign_name" class="block text-cement font-bold mb-2">Campaign Name:</label>
                              <input type="text" id="campaign_name" name="campaign_name" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 bg-cement text-white" ></input>
                           </div>
                           <div class="mb-4 bg-white p-4 rounded-lg shadow">
                              <label for="current_status" class="block text-cement font-bold mb-2">Current Status:</label>
                              <input type="text" id="current_status" name="current_status" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 bg-cement text-white" ></input>
                           </div>
                        </div>

                        <div class="grid grid-cols-4 gap-4 mt-4">
                           <div class="p-4 border rounded-lg bg-white">
                              <div class="bg-orange-500 p-4 text-white text-center cursor-pointer" id="clickBox">
                                 <p class="text-xl">Click</p>
                              </div>
                              <div class="bg-white p-4 text-center">
                                 <p class="text-xl font-semibold" id="clickCount">0</p>
                              </div>
                           </div>
                           <div class="p-4 border rounded-lg bg-white">
                              <div class="bg-pink-500 p-4 text-white text-center cursor-pointer" id="impressionBox">
                                 <p class="text-xl">Impression</p>
                              </div>
                              <div class="bg-white p-4 text-center">
                                 <p class="text-xl font-semibold" id="impressionCount">0</p>
                              </div>
                           </div>
                           <div class="p-4 border rounded-lg bg-white">
                              <div class="bg-indigo-500 p-4 text-white text-center cursor-pointer" id="reachBox">
                                 <p class="text-xl">Reach</p>
                              </div>
                              <div class="bg-white p-4 text-center">
                                 <p class="text-xl font-semibold" id="reachCount">0</p>
                              </div>
                           </div>
                           <div class="p-4 border rounded-lg bg-white">
                              <div class="bg-cyan-500 p-4 text-white text-center cursor-pointer" id="spendBox">
                                 <p class="text-xl">Spend</p>
                              </div>
                              <div class="bg-white p-4 text-center">
                                 <p class="text-xl font-semibold" id="Time_Spend">0</p>
                              </div>
                           </div>
                        </div>

                        <div class="mt-4">
                           <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" id="logButton" >
                              Log
                           </button>
                        </div>
                     </div>
