  ...
  return (
    <div className="bg-stone-300 flex flex-row  p-12 lg:p-24 xl:p-26 h-screen " >
      <div className="flex flex-row mx-auto max-w-[70%] max-h-auto bg-white rounded-3xl shadow-lg shadow-stone-400">
        ...
        <div className="w-1/2 h-full flex flex-col items-center justify-center overflow-hidden relative bg-gradient-to-br from-amaranth-100 to-purple-200 rounded-r-3xl px-4">
            {/* <h2 className="font-light text-4xl tracking-tighter text-purple-800">Proudly made by</h2> */}
            <h1 class="text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-br from-amaranth-600 to-purple-800">Secure Data Collaboration with DataHaven<span className="font-bold text-4xl text-amaranth-500">.</span></h1>
