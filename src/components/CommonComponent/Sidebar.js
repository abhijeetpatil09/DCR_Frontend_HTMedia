    ...
    <div className="  w-screen flex flex-col ">
      ...
      <div className="flex flex-grow w-full  h-[calc(100vh-60px)] overflow-auto">
        <aside
          ...
          }   flex flex-col items-start bg-deep-navy text-electric-green shadow h-[calc(100vh-60px)] sticky top-0  `}
        >
          {/* <!-- Side Nav Bar--> */}
        ...
        <main className="flex flex-col w-full ">
          ...
          <div className="bg-blue-100  h-10 flex flex-row items-center justify-end text-xs sticky bottom-0 px-10 py-2">
