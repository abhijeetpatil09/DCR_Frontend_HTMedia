        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="relative mx-auto max-w-[37.5rem] pb-24 pt-20 text-center">
            ...
            <p class="mt-4 text-base leading-7 text-slate-600">
              This policy is effective from 1st July 2015
            </p>
          </div>
        </div>
          ...
          <div class="prose-sm prose prose-slate prose-a:font-semibold prose-a:text-sky-500 hover:prose-a:text-sky-600 mx-auto max-w-[40rem]">
            <div>
              <h2 className="font-bold text-2xl text-gray-700 pb-2">
                Hoonartek – Business Privacy Policy
              </h2>
              <p>
                This privacy policy sets out how Hoonar Tekwurks (Hoonartek)
                uses and protects any information that you give us when you use
                this website.
              </p>
              <p>
                HoonarTek is committed to ensuring that your privacy is
              ...
              <p>
                Hoonartek may change this policy from time to time by updating
            ...
            <div className="mt-6 text-gray-600">
              ...
              <p className="text-gray-600">
                We require this information to understand your needs and either
                provide you with a better service or respond to your enquiry,
                and in particular for the following reasons:
              </p>
              <ul className="list-disc list-inside pl-6">
                <li>Internal record keeping.</li>
                <li>
                  We may use the information to improve our services and
                  offerings.
                </li>
                <li>
                  ...
                  or phone. We may use the information to customise the website
            ...
            <div className="mt-6 text-gray-600">
              ...
              <p>
                ...
                by law to do so. We will not use your personal information to
                send you promotional information about either ourselves or third
                parties.
              </p>
              <p>
                ...
                you please write to HoonarTek, 60 Cannon Street, London EC4N
                6NP.
              </p>
              <p>
                If you believe that any information we are holding on you is
                incorrect or incomplete, please write to us or email us as soon
