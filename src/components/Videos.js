          ...
          <ul className="flex flex-col pl-0 mb-0 rounded-lg">
            <li className="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
              <div className="flex items-center w-1/2">
                <div className="flex-auto p-4">
                  <h2 className="font-semibold mb-4 text-amaranth-700">Introduction to DCR</h2>
                  <video
                    width="100%"
                    height="240"
                    loop
              ...
              <div className="flex items-center w-1/2 ml-2">
                <div className="flex-auto p-4">
                  <h2 className="font-semibold mb-4 text-amaranth-700">Introduction to Log in and Match Rate feature</h2>
                  <video
                    width="100%"
                    height="240"
                    loop
            ...
            <li className="relative flex justify-between py-2 pr-4 mb-2 mt-5 border-0 rounded-t-lg rounded-xl text-inherit">
              <div className="flex items-center w-1/2">
                <div className="flex-auto p-4">
                  <h2 className="font-semibold mb-4 text-amaranth-700">Introduction to Customer Enrichment feature</h2>
                  <video
                    width="100%"
                    height="240"
                    loop
              ...
              <div className="flex items-center w-1/2 ml-2">
                <div className="flex-auto p-4">
                  <h2 className="font-semibold mb-4 text-amaranth-700" >Introduction to Admin console and status feature</h2>
                  <video
                    width="100%"
                    height="240"
                    loop
