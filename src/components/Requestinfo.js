        ...
        <table className="table-fixed  text-left text-sm">
          ...
          <tbody className="text-gray-600 text-sm font-light">
            <tr className="border-b border-gray-200 hover:bg-gray-100">
              ...
              <td
                className="border border-l-0 px-4 py-2"
                key="download-link.com"
              >
                <a
                  href="download-link.com"
            ...
            <div className="flex-auto p-4">
              <div className="flex flex-wrap -mx-3">
                <div className="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p className="mb-0 font-sans font-semibold leading-normal text-sm dark:opacity-60 text-gray-400">
                      This month's enrichment requests
                    </p>
                    <h5 className="mb-0 font-bold dark:text-white">
                      530
                      <span className="leading-normal text-sm font-weight-bolder text-lime-500 pl-2">
                        +2%
                      </span>
                    </h5>
                  </div>
            ...
            <div className="flex-auto p-4">
              <div className="flex flex-wrap -mx-3">
                <div className="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p className="mb-0 font-sans font-semibold leading-normal text-sm dark:opacity-60 text-gray-400">
                      This months's Match requests
                    </p>
                    <h5 className="mb-0 font-bold dark:text-white">
                      +3,462
                      <span className="leading-normal text-red-600 text-sm font-weight-bolder pl-0">
                        -2%
                      </span>
                    </h5>
                  </div>
                ...
                <div className="w-4/12 max-w-full px-3 text-right flex-0">
                  <div className="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500 shadow-soft-2xl">
                    <i
                      className="ni leading-none ni-paper-diploma text-lg relative top-3.5 text-white"
                      aria-hidden="true"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
